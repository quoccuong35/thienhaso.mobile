...
const SizedBox gSizedBox5 = SizedBox(height: hBox5);

const Divider dividerH2B = Divider(
  height: 2.0,
  color: Colors.black,
);
const Divider dividerH2B1w2 = Divider(
  height: 2.0,
